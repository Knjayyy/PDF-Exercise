    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between">
                ...
                <div class="flex">
                    <Link :href="'/clients/email/' + client.id" class="border border-gray-300 p-2 rounded shadow mr-2">Send Email</Link>
                    <a as="button" :href="'/clients/pdf/' + client.id" target="_blank" class="border border-gray-300 p-2 rounded shadow flex">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="-4 0 40 40" fill="none">
